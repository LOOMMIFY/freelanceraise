  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        // Mock data with gender-appropriate images
        ...
        const mockBusinesses: UserProfile[] = [
          {
            id: 'b1',
            name: 'TechCorp',
            avatar: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=500&q=80',
            role: 'business',
          },
          {
            id: 'b2',
            name: 'DesignStudio',
            avatar: 'https://images.unsplash.com/photo-1542744095-fcf48d80b0fd?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=500&q=80',
            role: 'business',
          },
          {
            id: 'b3',
            name: 'MarketingPro',
            avatar: 'https://images.unsplash.com/photo-1497366858526-0766cadbe8fa?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=500&q=80',
            role: 'business',
          },
        ];
